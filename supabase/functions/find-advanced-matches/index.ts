...
Deno.serve(async (req) => {
  ...
  try {
    ...
    try {
      // Note: L'appel à une autre fonction Edge par `supabaseAdmin.functions.invoke` est une pratique courante
      // dans l'écosystème Supabase, mais si l'utilisateur souhaite éviter toute dépendance "partagée"
      // ou tout appel inter-fonctions, cette partie pourrait nécessiter une refonte.
      // Pour l'instant, je la laisse car elle n'utilise pas `_shared/`.
